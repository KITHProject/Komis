            ...
            <nav className="flex items-center justify-between" aria-label="Global">
              ...
              <div className="hidden lg:flex lg:gap-x-12">
                {navigation.map((item, id) => (
                  <a key={id} href={item.href} className="text-sm font-semibold leading-6 text-gray-100 keychainify-checked">
                    {item.name}
                  </a>
                ))}
              </div>
                ...
                <div className="mt-6 flow-root">
                  <div className="-my-6 divide-y divide-gray-500/10">
                    <div className="space-y-2 py-6">
                      {navigation.map((item) => (
                        <a key={item.name} href={item.href} className="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-100 hover:bg-gray-400/10 keychainify-checked">
                          {item.name}
                        </a>
                      ))}
                    </div>
                    <div className="py-6">
                      <a href="#" className="-mx-3 block rounded-lg py-2.5 px-3 text-base font-semibold leading-6 text-gray-100 hover:bg-gray-400/10 keychainify-checked">
                        Log in
                      </a>
                    </div>
                  </div>
